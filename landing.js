(() => {
  const translations = {
    en: {
      ...
      navPrivacy: "Privacy",
      navInstall: "Install",
      heroEyebrow: "Chrome extension · Local preview",
      ...
      installCta: "Install the local build",
      ...
      installKicker: "Install the current build",
      installTitle: "Try it locally in Chrome.",
      installBody:
        "The extension is not in the Chrome Web Store yet. Install the unpacked build from this repository.",
      installOneTitle: "Open Chrome Extensions",
      installOneBody: "Visit",
      installOneEnd: "and enable Developer mode.",
      installTwoTitle: "Load the extension",
      installTwoBody:
        "Select Load unpacked and choose the Gmail Recipient Preview folder.",
      installThreeTitle: "Refresh Gmail",
      installThreeBody:
        "Open a draft and select Preview beside the discard button.",
      downloadGithub: "Open the GitHub repository",
    ...
    "zh-TW": {
      ...
      navPrivacy: "隱私",
      navInstall: "安裝",
      heroEyebrow: "Chrome 擴充功能 · 本機即時預覽",
      ...
      installKicker: "安裝目前版本",
      installTitle: "先在 Chrome 安裝測試版。",
      installBody:
        "目前版本尚未上架 Chrome Web Store，請從 GitHub 下載，並以未封裝擴充功能的方式載入。",
      installOneTitle: "開啟 Chrome 擴充功能頁面",
      installOneBody: "前往",
      installOneEnd: "並開啟「開發人員模式」。",
      installTwoTitle: "載入擴充功能",
      installTwoBody:
        "選擇「載入未封裝項目」，再選取 Gmail Recipient Preview 資料夾。",
      installThreeTitle: "重新整理 Gmail",
      installThreeBody: "開啟草稿，點選垃圾桶旁的「預覽」。",
      downloadGithub: "前往 GitHub Repository",
